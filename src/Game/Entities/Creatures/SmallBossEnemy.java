 ...
 */
public class SmallBossEnemy extends CreatureBase  {
    ...
    public SmallBossEnemy(Handler handler, float x, float y) {
    ...
    public void render(Graphics g) {
        ...
        g.drawRect((int)(x-handler.getGameCamera().getxOffset()-1),(int)(y-handler.getGameCamera().getyOffset()-21),81,11);
